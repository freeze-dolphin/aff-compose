...
internal fun Double.toPlainString(decimals: Int = 0): String = String.format("%.${decimals}f", this)

/**
 * Need fix: mis-formatted when encountering very big numbers
 */
internal val Double.affFormat: String
    get() {
        val rounded = (this * 100.0).roundToInt() / 100.0
        val str = rounded.toPlainString(2)
